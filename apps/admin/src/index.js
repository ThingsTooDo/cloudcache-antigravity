import { getEnv, AdminEnvSchema } from "@cloudcache/platform-env";
...
export default {
    async fetch(request, env) {
        ...
        if (pathname === "/healthz") {
            const response = createJSONResponse({ status: "ok", service: "admin", version: __VERSION__ }, 200, correlationId);
            return response;
        }
