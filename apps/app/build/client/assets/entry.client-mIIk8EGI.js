import { j as R } from "./jsx-runtime-BgjmLhhW.js";
import {
  E as h,
  i as C,
  f as M,
...
function T(n) {
  ...
  for (let [a, e] of x)
    if (e && e.__type === "RouteErrorResponse")
      u[a] = new h(e.status, e.statusText, e.data, e.internal === !0);
      ...
      if (e.__subType) {
        ...
        if (typeof i == "function")
          try {
            ...
            ((o.stack = e.stack), (u[a] = o));
          } catch {}
      }
      if (u[a] == null) {
        let i = new Error(e.message);
        ((i.stack = e.stack), (u[a] = i));
      }
    } else u[a] = e;
  return u;
}
  ...
  if (!t) {
    if (window.__remixContext.future.v3_singleFetch) {
      if (!s) {
        ...
        (C(d, "No stream found for single fetch decoding"),
    ...
    if (!window.__remixContext.isSpaMode) {
      ...
      if (d)
        for (let l of d) {
          ...
          c && E(w, c, window.__remixContext.isSpaMode) && (c.HydrateFallback || !w.hasLoader)
            ? (o.loaderData[_] = void 0)
            : w && !w.hasLoader && (o.loaderData[_] = null);
        }
      o && o.errors && (o.errors = T(o.errors));
    }
    ((t = S({
      routes: i,
      history: P(),
      ...
      dataStrategy:
        window.__remixContext.future.v3_singleFetch && !window.__remixContext.isSpaMode
          ? b(window.__remixManifest, window.__remixRouteModules, () => t)
          : void 0,
      patchRoutesOnNavigation: F(
...
function B() {
  ...
  p = 1;
  var n = O();
  return ((m.createRoot = n.createRoot), (m.hydrateRoot = n.hydrateRoot), m);
}
var I = B();
r.startTransition(() => {
  I.hydrateRoot(document, R.jsx(r.StrictMode, { children: R.jsx(q, {}) }));
});
