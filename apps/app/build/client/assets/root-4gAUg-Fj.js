...
let l = "positions";
function L({ getKey: e, ...o }) {
  let { isSpaMode: c } = h(),
    i = x(),
    u = y();
  S({ getKey: e, storageKey: l });
  let d = a.useMemo(() => {
    if (!e) return null;
    let s = e(i, u);
  ...
  let p = ((s, m) => {
    ...
    try {
      let n = JSON.parse(sessionStorage.getItem(s) || "{}")[m || window.history.state.key];
...
function _() {
  ...
  return t.jsxs("html", {
    children: [
      ...
      t.jsxs("body", {
        children: [t.jsx(M, { context: { host: e, apiKey: o } }), t.jsx(L, {}), t.jsx(k, {})],
      }),
    ],
  });
}
