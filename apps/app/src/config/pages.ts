    ...
    toggles: [
      {
        ...
        title: "Web Analytics",
        description:
          "Privacy-first analytics without client-side scripts. Zero impact on page performance.",
      ...
      },
      {
        ...
        description:
          "Collect performance metrics from actual visitors to understand real-world experience.",
        cfSettingName: "rum",
        valueType: "on_off",
      },
      {
        ...
        description:
          "Track LCP, FID, CLS, and INP—the metrics Google uses for page experience ranking.",
