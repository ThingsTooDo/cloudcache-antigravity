import { R as i, y as re, r as k, u as oe, a as ce, j as F } from "./components-pL6DFRjL.js";
import {
  u as J,
  c as E,
  v as de,
...
function M({
  ...
  style: T,
  lastFixedFirstColumn: _,
}) {
  const A = J(),
    V = r === "numeric",
    x = E(
      d.Cell,
      d[`Cell-${de("verticalAlign", p)}`],
    ...
    W = i.createElement(
      "span",
      { className: $ },
      i.createElement(he, { source: q, accessibilityLabel: Z })
    ),
    U = !(S && P && e && !f),
    b = u
      ? i.createElement(
    ...
    ae = s
      ...
      : i.createElement(
          "th",
          Object.assign({}, R, { ref: y, className: x, scope: "row", style: { ...L } }),
          n ? i.createElement(_e, { className: d.TooltipContent }, h) : h
        ),
    ie = s || t || e ? ae : i.createElement("td", Object.assign({ className: x }, R), h);
  return S ? j : ie;
}
const _e = ({ children: h, className: r = "" }) => {
  const e = k.useRef(null),
    { current: t } = e,
    n = i.createElement("span", { ref: e, className: r }, h);
  return t?.scrollWidth > t?.offsetWidth
    ? i.createElement(ue, { content: e.current.innerText }, n)
    : n;
};
function xe({ children: h, onMount: r, fallback: e = null }) {
  const t = fe(),
    n = t ? h : e;
  return (
    k.useEffect(() => {
...
function Re() {
  const h = k.useContext(me);
  if (!h) throw new pe("No StickyManager was provided.");
  return h;
}
...
class Ae extends k.PureComponent {
  ...
  render() {
    const {
      ...
      N = r.slice(0, y),
      T = e?.slice(0, y),
      _ = this.table.current?.children[0].childNodes,
      ...
      B =
        ...
        i.createElement(
          ...
          i.createElement(
            ...
            null,
            I.map((g, b) =>
              this.defaultRenderRow({ row: g, index: b, inFixedNthColumn: !0, rowHeights: x })
            )
          ),
          e &&
            t &&
      ...
      q = f ? i.createElement(ve, Object.assign({ type: "table" }, f)) : null,
      z = t ? null : P,
...
function je() {
    ...
    n = F.jsx(Se, {
      ...
      children: F.jsx(Y, {
        children: F.jsx(Y.Section, {
          children: F.jsxs(Te, {
            children: [
              F.jsx(Ee, { as: "h2", variant: "headingMd", children: "Product List" }),
              F.jsx(Ve, {
  ...
  return r && e ? F.jsx(ke, { apiKey: e, host: r, children: n }) : n;
}
