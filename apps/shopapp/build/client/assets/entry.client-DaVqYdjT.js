import { j as v } from "./jsx-runtime-BgjmLhhW.js";
import {
  E as p,
  i as C,
  d as M,
...
function T(n) {
  ...
  for (let [a, e] of x)
    if (e && e.__type === "RouteErrorResponse")
      u[a] = new p(e.status, e.statusText, e.data, e.internal === !0);
    ...
    ((t = S({
      ...
      dataStrategy:
        window.__remixContext.future.v3_singleFetch && !window.__remixContext.isSpaMode
          ? F(window.__remixManifest, window.__remixRouteModules, () => t)
          : void 0,
...
var I = q();
r.startTransition(() => {
  I.hydrateRoot(document, v.jsx(r.StrictMode, { children: v.jsx(B, {}) }));
});
