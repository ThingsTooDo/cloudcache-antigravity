...
- [x] Scour codebase for "shopapp" occurrences <!-- id: 0 -->
  ...
  - [x] Search file contents <!-- id: 2 -->
  - [x] Identify Database and KV references <!-- id: 3 -->
- [x] Create Implementation Plan <!-- id: 4 -->
- [x] Execute Rename <!-- id: 5 -->
  - [x] Rename directories and files <!-- id: 6 -->
  - [x] Update code references <!-- id: 7 -->
    - [x] Update configuration (wrangler.toml, package.json) <!-- id: 8 -->
