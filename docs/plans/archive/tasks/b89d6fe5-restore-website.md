...
- [x] Analyze `apps/app` (Shopify) deployment <!-- id: 1 -->
  - [x] Check `wrangler.toml` <!-- id: 2 -->
  - [x] Check `package.json` build scripts <!-- id: 3 -->
- [x] Analyze `apps/admin` deployment <!-- id: 4 -->
  - [x] Check `wrangler.toml` <!-- id: 5 -->
  - [x] Check `package.json` build scripts <!-- id: 6 -->
- [x] Analyze `apps/website` deployment <!-- id: 7 -->
  - [x] Check `wrangler.toml` <!-- id: 8 -->
  - [x] Check `package.json` build scripts <!-- id: 9 -->
- [x] Analyze `apps/apex` deployment (if exists) <!-- id: 10 -->
  - [x] Check `wrangler.toml` <!-- id: 11 -->
  - [x] Check `package.json` build scripts <!-- id: 12 -->
