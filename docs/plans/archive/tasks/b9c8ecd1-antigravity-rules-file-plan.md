...
- [x] Research existing rules and documentation <!-- id: 0 -->
  - [x] Read `.cursorrules` <!-- id: 1 -->
  - [x] Read `ARCHITECTURE-GENERAL.md` <!-- id: 2 -->
  - [x] Read `docs/*-truth.md` files <!-- id: 3 -->
- [x] Create Implementation Plan <!-- id: 4 -->
  - [x] Draft proposed rules structure <!-- id: 5 -->
  - [x] Define integration of "truth" files <!-- id: 6 -->
- [x] Execute Rules File Plan <!-- id: 7 -->
  - [x] Rename `docs/zero-trust/TOKENS.md` to `docs/zero-trust/tokens.md` <!-- id: 10 -->
