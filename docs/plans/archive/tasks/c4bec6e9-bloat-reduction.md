...
- [x] Scan codebase for large files <!-- id: 0 -->
- [x] Analyze top candidates for bloat <!-- id: 1 -->
- [x] Generate "Bloated File Optimization" report <!-- id: 2 -->
- [x] Analyze dependencies for bloated files <!-- id: 3 -->
- [x] Create "Bloated File Reduction Plan" <!-- id: 4 -->

## Phase 1: Foundation

- [x] Refactor `styles.ts` to `main.css` <!-- id: 5 -->
- [x] Refactor `platform-http` package <!-- id: 6 -->
