...
|----|----------|-------------|-------|-----|
| **BQI‑001** | Naming Consistency | Execute the *Naming Consistency Plan* (see `docs/plans/naming-consistency-plan-2025-11-24.md`) to eradicate all `shopify` remnants. | Lead Engineer | 2025‑11‑30 |
