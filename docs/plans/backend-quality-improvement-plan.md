...
| ----------- | ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | ---------- |
| **BQI‑001** | Naming Consistency       | Execute the _Naming Consistency Plan_ (see `docs/plans/naming-consistency-plan.md`) to eradicate all `shopify` remnants.                                                                              | Lead Engineer        | 2025‑11‑30 |
